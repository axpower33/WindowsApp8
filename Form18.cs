...
namespace WindowsFormsApp8
{
    public partial class Form18 : Form
    {
        ...
        private void Form18_Load(object sender, EventArgs e)
        {
            ...
            db = new SqlConnection(@"Data Source = DESKTOP-A6RFH6A\SQLEXPRESS; Initial Catalog = Fractals;Integrated Security = Yes;");
            ...
            //crystalReport11.SetParameterValue(0,"Акула");
            //crystalReport11.SetParameterValue(1, "Дельфин");
