...
namespace WindowsFormsApp8
{
    partial class Form15
    {
        ...
        private void InitializeComponent()
        {
			...
			this.frspTableAdapter1 = new WindowsFormsApp8.fractalsDataSetTableAdapters.FRSPTableAdapter();
			...
			//reportDataSource2.Name = "DataSet9";
			...
			// frspTableAdapter1
			// 
			this.frspTableAdapter1.ClearBeforeFill = true;
			// 
			// Form15
			// 
		...
		private fractalsDataSetTableAdapters.FRSPTableAdapter frspTableAdapter1;
	}
}